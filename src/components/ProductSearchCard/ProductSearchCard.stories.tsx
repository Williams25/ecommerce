...
import { ProductSearchCard, ProductSearchCardProps } from "./index";

export default {
  title: "Components/ProductSearchCard",
...
} as Meta<ProductSearchCardProps>;

export const Basic: Story<ProductSearchCardProps> = (args) => (
